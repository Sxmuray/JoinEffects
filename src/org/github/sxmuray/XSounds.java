package org.github.sxmuray.utils;
...
public enum XSound {
    ...
    public static CompletableFuture<Record> play(@Nonnull Player player, String sound) {
    ...
    public static CompletableFuture<Record> play(@Nonnull Location location, String sound) {
    ...
    public static CompletableFuture<Record> parse( Player player, @Nonnull Location location,  String sound, boolean play) {
    ...
    public static class Record {
        ...
        public Record(@Nonnull Sound sound, Player player, @Nonnull Location location, float volume, float pitch, boolean playAtLocation) {
            this.sound = sound;
            this.player = player;
